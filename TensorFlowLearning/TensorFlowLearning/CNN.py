...
def conv2d(x,W):
    ...
    # W filler /kernel tensor of shape [filter_height, filter_width, in_channels, out_channels]
...
with tf.name_scope('Conv1'):
    with tf.name_scope('W_conv1'):
        #初始化第一个卷积层的权值和偏置
        W_conv1 = weight_variable([5,5,1,32],name='W_conv1')#5*5的采样窗口，32个卷积核从1个平面(黑白图片)抽取特征
